...
public class AppRunFromDatabase {

    private final KeyPad keyPad;
    private final Screen screen;
    private final AccountServiceDatabase accountService;
    private final CardServiceDatabase cardService;
    private final CustomerServiceDatabase customerService;
    private final TransactionServiceDatabase transactionService;
    ...
    public AppRunFromDatabase(KeyPad keyPad, Screen screen, AccountServiceDatabase accountService, CardServiceDatabase cardService, CustomerServiceDatabase customerService, TransactionServiceDatabase transactionService) {
        this.keyPad = keyPad;
        this.screen = screen;
    ...
    private void payment() {
        ...
        if(account.isEmpty())
            return;
        try {
            screen.displayMessage("Enter the amount you want to pay:");
            var amount = keyPad.readString();
            if(Double.parseDouble(amount) <= 0)
            {
                throw new IllegalArgumentException("The amount must be positive!");
